				...
				<div class="card card-bg">
					<div class="card-body text-center">
						...
						<div class="row">
							...
							<a href="view_books.jsp?bid=<%=b.getBookId()%>" class="btn btn-sm btn-success ml-5">View Details</a> <a
								href="" class="btn btn-sm btn-custom ml-3"><%=b.getPrice()%> <i
								class="fa-solid fa-indian-rupee-sign"></i></a>
						</div>
						<%
						}
					...
					<div class="card card-bg">
						<div class="card-body text-center">
							...
							%>
								...
								<%}else{
								%>
									<a href="cartServlet" class="btn btn-sm btn-custom	ml-4">Add Cart</a>
